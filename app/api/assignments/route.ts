...
import { createAssignment } from '@/src/use-cases/create-assignment';

export const dynamic = 'force-dynamic';

const schema = z.object({
  shiftId: z.string().min(1, 'indique el turno').max(100),
  operatorId: z.string().min(1, 'indique el operador').max(100),
  ...
  override: z
    .object({
      reason: z
        .string()
        .min(15, 'el motivo debe tener al menos 15 caracteres')

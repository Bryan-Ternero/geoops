                ...
                <tr key={f.id} className={bloquea ? 'bg-bloqueo-dim' : undefined}>
                  ...
                  <td className={tabla.td}>
                    <input
                      ...
                      className="w-24 rounded-sm border border-line bg-canvas px-2 py-2 text-right font-mono text-sm"
                    />
                  </td>
                  <td className={`${tabla.td} text-xs`}>
                    ...
                    {bloquea && (
                      <strong className="ml-1 text-bloqueo">· quedará BLOQUEADO</strong>
                    )}
                  </td>
                  <td className={tabla.td}>
                    <input
                      ...
                      className={`w-64 rounded-sm px-2 py-2 text-sm ${
                        desvioGrande(f)
                          ? 'border border-aviso/50 bg-aviso-dim'

...
export function RevocarCertificacion({
  ...
  return (
    <form action={accion}>
      ...
      <button
        type="submit"
        className="inline-flex items-center gap-1.5 border border-line px-3 py-1.5 text-xs whitespace-nowrap transition-colors hover:border-bloqueo hover:text-bloqueo"
      >
      ...
      {estado.error && (
        <p role="alert" className="mt-1 text-xs text-bloqueo">
          {estado.error}
        </p>
      )}
    </form>

...
import type { Role } from '../infrastructure/database/generated/enums';
import { prisma } from '../infrastructure/database/prisma';
import { ServiceError } from '../use-cases/errors';
  ...
  providers: [
    Credentials({
      ...
      async authorize(credentials) {
        ...
        if (!email || !password || email.length > 255 || password.length > 1000) {
          return null;
        }
